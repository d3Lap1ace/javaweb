...
let showdata = ()=>{
   loadByPage().then(
      response  =>{
         //加载完,获取axios数据,并赋值
         //Object.assign(schedule.jsondata,response.data.data)
         schedule.jsondata = response.data.data;
      }
   )
}
...
<template>
   <div class="common-layout">
      ...
      <el-container>
         <el-main>
            <!-- 表格 -->
            <el-table :data="schedule.jsondata" style="width: 100%">
